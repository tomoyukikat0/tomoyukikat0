...
主にバックエンドエンジニアとして、設計・実装を担当した。フロントエンドの開発者が足りないときはフロントエンドの開発も担当した。
...
<役割>
バックエンドエンジニア、フロントエンドエンジニア、スクラムマスター、薬剤師マネジメント

<実績・取り組みなど>
サービスの立ち上げからサービスがクローズされるまで参加。エンジニアとして機能開発の企画段階から入り、機能実装・リリース・保守運用まで担当した。薬剤師向けアプリケーションの開発では、実際に薬局に赴き、薬剤師にヒアリングした上で生産性向上のための機能開発を行い、生産性向上に貢献した。またスクラムマスターとして、円滑なスクラム開発を行えるよう取り組んだ。
